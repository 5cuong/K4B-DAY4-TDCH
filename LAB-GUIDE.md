...
Tránh đổi nhiều quy tắc và sửa schema cùng lúc nếu muốn biết thay đổi nào tạo
ra kết quả. Giữ nguyên tên công cụ có sẵn và các tình huống kiểm tra cố định;
công cụ mới của nhóm được kiểm tra bằng tình huống do nhóm tự viết.
